...
@Entity
@Table(name = "future_2day_appointments",
        indexes = {
                @Index(name = "idx_future_appointments_doctor_time", columnList = "doctor_id, appointment_time"),
                @Index(name = "idx_future_appointments_user", columnList = "user_id"),
                @Index(name = "idx_future_appointments_date", columnList = "appointment_date"),
                @Index(name = "idx_future_appointments_workplace", columnList = "workplace_id"),
                @Index(name = "idx_future_appointments_slot", columnList = "slot")
        })
public class FutureTwoDayAppointment {
    ...
    // Constructors
    public FutureTwoDayAppointment() {}
